...
const Terms = (): JSX.Element => {
  return (
    ...
    <div className={ styles.container }>
      <SubHeader
        title="利用規約"
        text="以下の規約を熟読したうえでのご利用をお願いします"
      />
      <div className={ styles.sentence }>
        <p>この利用規約（以下、「本規約」といいます。）は、WithRice（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。</p>
        <h2>第1条（適用）</h2>
        <ol>
